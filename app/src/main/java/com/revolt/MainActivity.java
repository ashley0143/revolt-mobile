...
public class MainActivity extends Activity {
	...
	private void initializeLogic() {
		webview1.loadUrl("https://app.revolt.chat/");
		webview1.getSettings().setJavaScriptEnabled(true);
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
				...
				.setLongLabel("Settings")
					.setIcon(android.graphics.drawable.Icon.createWithResource(MainActivity.this, R.drawable.set))
				.setIntent(new Intent(Intent.ACTION_MAIN, Uri.EMPTY, MainActivity.this, SettingsActivity.class))
				...
				.setIcon(android.graphics.drawable.Icon.createWithResource(MainActivity.this, R.drawable.friens))
				.setIntent(new Intent(Intent.ACTION_MAIN, Uri.EMPTY, MainActivity.this, FriendsActivity.class))
				.build();
